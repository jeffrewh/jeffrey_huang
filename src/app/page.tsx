          ...
          >
            ...
            <div>
              <p className="mb-4 text-base text-slate-400 leading-relaxed">
                ...
                phrase. I'm an aspiring engineer, passionate in nigh all things
                learning, and thusly, tend to get my fingers stuck in too many
                pies. I liken it to &quot;knowledge-FOMO&quot;, if you will.
              </p>
              <p className="mb-4 text-base text-slate-400 leading-relaxed">
                ...
                <li className="mb-12">
                  <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                    ...
                    <div className="z-10 sm:col-span-6">
                      ...
                      {/* No tags for this one in your original, add if needed */}
                    </div>
                  </div>
                </li>
              </ol>
