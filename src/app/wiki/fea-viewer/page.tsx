...
export default function FeaViewerPage() {
  return (
    <DesktopWindow title="Ansys Mechanical • Equivalent Stress">
      <div className="flex h-full flex-col">
        <header className="border-b border-slate-700 bg-[#1f2733]">
          <div className="flex items-center gap-2 px-3 py-2">
            <span className="rounded bg-[#2e3a4d] px-2 py-1 text-xs text-slate-200">Home</span>
            <span className="rounded bg-[#2e3a4d] px-2 py-1 text-xs text-slate-200">Results</span>
            <span className="rounded bg-[#2e3a4d] px-2 py-1 text-xs text-slate-200">Probe</span>
            <span className="rounded bg-[#2e3a4d] px-2 py-1 text-xs text-slate-200">View</span>
          </div>
        </header>
        ...
        <div className="flex min-h-0 flex-1">
          ...
          <main className="relative min-w-0 flex-1">
            <ModelViewport modelPath="/models/impeller_deformed.glb" />
            <div className="pointer-events-none absolute right-4 top-1/2 z-30 w-16 -translate-y-1/2 rounded border border-slate-400/40 bg-slate-900/80 p-2 text-[10px] text-slate-200">
              <div className="mb-2 text-center text-[10px]">Von Mises (MPa)</div>
              <div
